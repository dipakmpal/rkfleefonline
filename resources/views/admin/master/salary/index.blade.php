...
<div class="tms-page-content" id="page-purchase">
    <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <h4 class="fw-bold mb-0 text-dark">Add Salary</h4>
            </div>
    ...
    Add New Expense
                ...
                <a href="{{ route('salary.create') }}" class="btn btn-outline-primary btn-sm bg-white border">
                    <i class="fas fa-list me-1"></i> Create salary
                </a>
