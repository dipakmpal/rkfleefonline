...
<style>
    ...
    #pills-tabContent .tab-pane.show.active {
        display: block;
    }
</style>
...
<div class="tms-page-content">
    ...
    <div class="tab-content" id="pills-tabContent">
        <form action="{{ route('customer-master-store') }}" method="POST" enctype="multipart/form-data" id="mastercreateForm">
            @csrf
                ...
                <div class="row">
                    <div class="col-6">                    
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" id="name" required autofocus placeholder="Enter your customer name.">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="gstNumber" class="form-control" id="gstNumber" required autofocus placeholder="Enter your GST number.">
                        </div>
                        <div class="mb-3">
                            <label for="customerCode" class="form-label">Customer Code</label>
                            <input type="text" name="customerCode" class="form-control" id="customerCode" placeholder="Enter your customer code."> 
                        </div>
                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-6">                    
                        <div class="mb-3">
                            ...
                            <input type="email" name="customeremail" class="form-control" id="customeremail" required autofocus placeholder="Enter your customer email.">
                        </div>
                        <div class="mb-3">
                            <label for="monumber" class="form-label">Mobile Number</label>
                            <input type="number" name="monumber" class="form-control" id="monumber" placeholder="Enter your mobile number."> 
                        </div>
                        <div class="mb-3">
                            <label for="contactperson" class="form-label">Contact Person</label>
                            <input type="text" name="contactperson" class="form-control" id="contactperson" placeholder="Enter the contact person's name."> 
                        </div>                                   
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="hirer" class="form-label">Hirer</label>
                            <input type="text" name="hirer" class="form-control" id="hirer" placeholder="Enter the hirer's name.">
                        </div>
                        <div class="mb-3">
                            <label for="whatsappNumber" class="form-label">WhatsApp Number</label>
                            <input type="number" name="whatsappNumber" class="form-control" id="whatsappNumber" placeholder="Enter your WhatsApp number."> 
                        </div>                        
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-6">   
                        <div class="mb-3">
                            ...
                            <input type="number" name="tds" class="form-control" id="tds" placeholder="Enter the TDS percent.">
                        </div>                 
                        <div class="mb-3">
                            <label for="openingbalance" class="form-label">Opening Balance</label>
                            <input type="number" name="openingbalance" class="form-control" id="openingbalance" required autofocus placeholder="Enter the opening balance.">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="vendorcode" class="form-control" id="vendorcode" placeholder="Enter the vendor code."> 
                        </div>                                   
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="biltycharges" class="form-label">Bilty Charges</label>
                            <input type="number" name="biltycharges" class="form-control" id="biltycharges" placeholder="Enter the bilty charges.">
                        </div>
                        <div class="mb-3">
                            <label for="creditlimit" class="form-label">Credit Limit</label>
                            <input type="number" name="creditlimit" class="form-control" id="creditlimit" placeholder="Enter the credit limit.">
                        </div>                       
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-6">   
                        <div class="mb-3">
                            ...
                            <select id="billformate" name="billformate"  class="form-label">
                                ...
                                <option value="LR billing">LR billing</option>
                                <option value="Bill Annexure">Bill Annexure</option>
                                <option value="bill">Bill</option>
                                <option value="velan">Velan</option>
                                <option value="bill2">Bill 2</option>
                                <option value="Challan to bill">Challan to bill</option>
                                <option value="Challan Bill new">Challan Bill new</option>
                                <option value="Charges bill">Charges bill</option>
                            </select>
                        </div>                 
                        <div class="mb-3">
