...
<div class="tms-page-content" id="page-purchase">
    ...
    {{-- <header class="mb-4 mt-2 lg:mb-5">
        <div class="flex flex-col @lg:flex-row @lg:items-center @lg:justify-between"><div></div>
        <div class="relative">
            <h3 class="rizzui-title-h3 text-base font-semibold sm:text-lg text-center md:text-left">Customer Master</h3>
            <span class="mt-2 absolute left-0 bottom-0 w-full h-1 bg-indigo-400 rounded-full"></span>
        </div>
        <div>
            <button class="rizzui-button inline-flex font-medium items-center justify-center active:enabled:translate-y-px focus:outline-none focus-visible:ring-[1.8px] focus-visible:ring-offset-2 ring-offset-background transition-colors duration-200 px-4 py-2 text-sm h-10 rounded-md bg-transparent border border-muted dark:backdrop-blur focus-visible:ring-muted hover:text-primary hover:border-primary w-full @lg:w-auto mr-5" type="button">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 256 256" class="me-1.5 h-[17px] w-[17px]" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg>Import Customers
            </button>
            <span class="rizzui-button inline-flex font-medium items-center justify-center active:enabled:translate-y-px focus:outline-none focus-visible:ring-[1.8px] focus-visible:ring-offset-2 ring-offset-background transition-colors duration-200 px-4 py-2 text-sm h-10 rounded-md bg-transparent border border-muted dark:backdrop-blur focus-visible:ring-muted hover:text-primary hover:border-primary w-full @lg:w-auto dark:bg-gray-100 dark:text-white dark:active:bg-gray-100 hover:cursor-pointer">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 256 256" class="me-1.5 h-[17px] w-[17px]" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <path d="M228,128a12,12,0,0,1-12,12H140v76a12,12,0,0,1-24,0V140H40a12,12,0,0,1,0-24h76V40a12,12,0,0,1,24,0v76h76A12,12,0,0,1,228,128Z"></path>
                </svg>Add Customer</span></div></div>
    </header> --}}
