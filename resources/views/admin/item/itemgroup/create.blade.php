    ...
    <div class="tms-page-content" id="page-purchase">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <h4 class="fw-bold mb-0 text-dark">Add Account Group</h4>
            </div>
            <div class="d-flex gap-2">
                <a href="{{ route('accountgroup.index') }}" class="btn btn-outline-primary btn-sm bg-white border">
                    <i class="fas fa-list me-1"></i>Account Group list
                </a>
            </div>
        </div>
        <div class="m-2">
        <form action="{{ route('accountgroup.store') }}" method="POST" enctype="multipart/form-data" id="mastercreateForm">
        @csrf
            <div class="row m-2">
                <div class="col-6">                    
                    <div class="mb-3">
                ...
                <div class="col-6">    
                    <div class="mb-3">
                        <label for="salaryType" class="form-label">Select Group</label>
